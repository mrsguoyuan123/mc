	...
	<view class="login-container">
		...
		<view class="login-card ">
			...
			<view class="text-center">
				<text class="card-body">连接医生与患者的康复桥梁</text>
			...
			<u-form :modelValue="formData" ref="form">
				...
				<button class="button-login button-white" type="default" @click="handleLogin"
					...
					<view>
						...
						<u-radio-group v-model="formData.checkbox">
							...
							<u-radio shape="circle">
								<text class="size-xs font-info">我已阅读并同意</text>
								<text class="size-xs font-primary">《用户服务协议》</text>
								<text class="size-xs font-info">与</text>
								<text class="size-xs font-primary">《隐私条款》</text>
